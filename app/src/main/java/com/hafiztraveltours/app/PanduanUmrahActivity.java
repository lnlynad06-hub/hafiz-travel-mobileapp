 ...
 *
 * Text sizes bumped up throughout for readability by older jemaah.
 */
public class PanduanUmrahActivity extends AppCompatActivity {
    ...
    private View buildSectionItem(SectionItem section) {
        ...
        summary.setText(getString(section.bodyResId));
        summary.setTextSize(17); // was 13 - bigger for elderly jemaah
